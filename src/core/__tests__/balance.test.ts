...
describe("AC-20 後半への布石 TRF グループは資金繰りには含まれる", () => {
  /* AC-20 の後半は「月次資金繰り表の出金に含まれること（CL-6）」であり、
     要件定義書 §9 のとおり CL-6 の実装後に検証する（フェーズ1・タスク#5）。
     ここでは、その前提となる CL-3 の残高に効くことまでを確かめる。 */
